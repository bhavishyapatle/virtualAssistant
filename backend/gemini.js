...
const geminiResponse = async (command,assistantName,userName)=> {
    try {
        ...
        Type meanings:
        - "general": if it's a factual or informational question. aur agar koi aisa question poochta hai jiska answer tumhe pata hai usko bhi general ki category me rakho bas short answer dena 
